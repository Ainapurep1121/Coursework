...
void encrypt(unsigned char * msg_ascii, unsigned char * key_ascii, unsigned int * msg_enc, unsigned int * key)
{
	...
	for (i = 0; i < 32; i = i + 2){
		State[i/2] = charsToHex(msg_ascii[i], msg_ascii[i+1]);
		RoundKey[i/2] = charsToHex(key_ascii[i], key_ascii[i+1]);
	}

	key[0] = (uint)((RoundKey[0] << 24) & 0xF000) & (uint)((RoundKey[1] << 16) & 0x0F00) & (uint)((RoundKey[2] << 8) & 0x00F0) & (uint)((RoundKey[3]) & 0x000F);
	key[1] = (uint)((RoundKey[4] << 24) & 0xF000) & (uint)((RoundKey[5] << 16) & 0x0F00) & (uint)((RoundKey[6] << 8) & 0x00F0) & (uint)((RoundKey[7]) & 0x000F);
	key[2] = (uint)((RoundKey[8] << 24) & 0xF000) & (uint)((RoundKey[9] << 16) & 0x0F00) & (uint)((RoundKey[10] << 8) & 0x00F0) & (uint)((RoundKey[11]) & 0x000F);
	key[3] = (uint)((RoundKey[12] << 24) & 0xF000) & (uint)((RoundKey[13] << 16) & 0x0F00) & (uint)((RoundKey[14] << 8) & 0x00F0) & (uint)((RoundKey[15]) & 0x000F);
	...
	SubBytes(State);
	ShiftRows(State);
	KeyExpansion(KeySchedule, RoundKey, 11);
	AddRoundKey(State, RoundKey);

	msg_enc[0] = (uint)((State[0] << 24) & 0xF000) & (uint)((State[1] << 16) & 0x0F00) & (uint)((State[2] << 8) & 0x00F0) & (uint)((State[3]) & 0x000F);
	msg_enc[1] = (uint)((State[4] << 24) & 0xF000) & (uint)((State[5] << 16) & 0x0F00) & (uint)((State[6] << 8) & 0x00F0) & (uint)((State[7]) & 0x000F);
	msg_enc[2] = (uint)((State[8] << 24) & 0xF000) & (uint)((State[9] << 16) & 0x0F00) & (uint)((State[10] << 8) & 0x00F0) & (uint)((State[11]) & 0x000F);
	msg_enc[3] = (uint)((State[12] << 24) & 0xF000) & (uint)((State[13] << 16) & 0x0F00) & (uint)((State[14] << 8) & 0x00F0) & (uint)((State[15]) & 0x000F);
}
