...
module lab7_soc_mm_interconnect_0 (
	...
	wire    [8:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> nios2_qsys_0_instruction_master_agent:rp_channel
	...
	wire  [106:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> nios2_qsys_0_debug_mem_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // nios2_qsys_0_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [8:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> nios2_qsys_0_debug_mem_slave_agent:cp_channel
	...
	wire  [106:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> led_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // led_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> led_s1_agent:cp_channel
	...
	wire   [28:0] key0_s1_agent_m0_address;                                                           // key0_s1_agent:m0_address -> key0_s1_translator:uav_address
	...
	wire  [107:0] key0_s1_agent_rf_source_data;                                                       // key0_s1_agent:rf_source_data -> key0_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] key0_s1_agent_rsp_fifo_out_data;                                                    // key0_s1_agent_rsp_fifo:out_data -> key0_s1_agent:rf_sink_data
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> key0_s1_agent:cp_valid
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> key0_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // key0_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key0_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> key0_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> key0_s1_agent:cp_endofpacket
	...
	wire   [28:0] key1_s1_agent_m0_address;                                                           // key1_s1_agent:m0_address -> key1_s1_translator:uav_address
	...
	wire  [107:0] key1_s1_agent_rf_source_data;                                                       // key1_s1_agent:rf_source_data -> key1_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] key1_s1_agent_rsp_fifo_out_data;                                                    // key1_s1_agent_rsp_fifo:out_data -> key1_s1_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> key1_s1_agent:cp_data
	...
	wire  [106:0] nios2_qsys_0_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_0_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [106:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_005:sink_data
	...
	wire          key0_s1_agent_rp_valid;                                                             // key0_s1_agent:rp_valid -> router_009:sink_valid
	wire  [106:0] key0_s1_agent_rp_data;                                                              // key0_s1_agent:rp_data -> router_009:sink_data
	wire          key0_s1_agent_rp_ready;                                                             // router_009:sink_ready -> key0_s1_agent:rp_ready
	wire          key0_s1_agent_rp_startofpacket;                                                     // key0_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          key0_s1_agent_rp_endofpacket;                                                       // key0_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [106:0] key1_s1_agent_rp_data;                                                              // key1_s1_agent:rp_data -> router_010:sink_data
	...
	wire    [8:0] cmd_demux_001_src5_channel;                                                         // cmd_demux_001:src5_channel -> cmd_mux_006:sink1_channel
	...
	wire  [106:0] cmd_demux_001_src6_data;                                                            // cmd_demux_001:src6_data -> cmd_mux_007:sink1_data
	wire          cmd_demux_001_src6_ready;                                                           // cmd_mux_007:sink1_ready -> cmd_demux_001:src6_ready
	wire    [8:0] cmd_demux_001_src6_channel;                                                         // cmd_demux_001:src6_channel -> cmd_mux_007:sink1_channel
	...
	wire  [106:0] cmd_demux_001_src7_data;                                                            // cmd_demux_001:src7_data -> cmd_mux_008:sink1_data
	wire          cmd_demux_001_src7_ready;                                                           // cmd_mux_008:sink1_ready -> cmd_demux_001:src7_ready
	wire    [8:0] cmd_demux_001_src7_channel;                                                         // cmd_demux_001:src7_channel -> cmd_mux_008:sink1_channel
	...
	wire    [8:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> rsp_mux_001:sink5_channel
	...
	wire  [106:0] rsp_demux_007_src1_data;                                                            // rsp_demux_007:src1_data -> rsp_mux_001:sink6_data
	wire          rsp_demux_007_src1_ready;                                                           // rsp_mux_001:sink6_ready -> rsp_demux_007:src1_ready
	wire    [8:0] rsp_demux_007_src1_channel;                                                         // rsp_demux_007:src1_channel -> rsp_mux_001:sink6_channel
	...
	wire  [106:0] rsp_demux_008_src1_data;                                                            // rsp_demux_008:src1_data -> rsp_mux_001:sink7_data
	wire          rsp_demux_008_src1_ready;                                                           // rsp_mux_001:sink7_ready -> rsp_demux_008:src1_ready
	wire    [8:0] rsp_demux_008_src1_channel;                                                         // rsp_demux_008:src1_channel -> rsp_mux_001:sink7_channel
	...
	wire          key0_s1_agent_rdata_fifo_src_valid;                                                 // key0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] key0_s1_agent_rdata_fifo_src_data;                                                  // key0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          key0_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_007:in_0_ready -> key0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> key0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> key0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // key0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> key0_s1_agent:rdata_fifo_sink_error
	...
	lab7_soc_mm_interconnect_0_router_005 router_005 (
	...
	lab7_soc_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
